...
{
    //  var connStr = @"Server=(localdb)\MSSQLLocalDB;Database=DabDb;User ID=DabLogin;Password=P@ssw0rd!;TrustServerCertificate=True;ApplicationIntent=ReadWrite;";

    // Environment.SetEnvironmentVariable("", connStr);
